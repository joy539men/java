...
public class Brad49 {
	...
	public static void main(String[] args) {
		...
		try {
			ObjectOutputStream oout = new ObjectOutputStream(new FileOutputStream("dir1/tt"));
